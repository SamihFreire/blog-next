...
export function FeatureSection() {
    return (
        <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
            ...
            {/* col-span-full utilizado para ocupar todo o espaço */}
            <div className="col-span-full flex flex-col gap-2">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
                    <div className="flex flex-col gap-4">
                        ...
                        {/* Quando você usa asChild, o componente Button não renderiza o <button>, e sim passa todos os estilos e comportamentos para o elemento filho (no caso, o <Link>). */}
